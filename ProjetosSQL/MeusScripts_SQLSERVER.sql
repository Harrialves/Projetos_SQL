...
INSERT INTO PRODUTOS VALUES('LIÇENCA POWERCENTER', 'SOFTWARES', 450000.00)
...
SELECT SUSER_NAME() AS O_PATRAO
GO

/* TRIGGER DA DADOS - DATA MANIPULATION LANGUAGE */
...
UPDATE PRODUTOS SET NOME = 'LIVROS C#'
WHERE IDPRODUTO = 1
GO
...
DECLARE
	...
	SET @RESULTADO =(SELECT 50 + 50)
	INSERT INTO RESULTADO VALUES(@RESULTADO)
	PRINT CAST(@RESULTADO AS VARCHAR) + 'VALOR INSERIDO NA TABELA' 
	GO
...
/* PROJECAO DA TABELA HIST_SALARIO COM O NOME */
SELECT E.NOME, H.IDEMPREGADO, H.ANTIGOSAL, H.NOVOSAL, H.DATA 
FROM EMPREGADO E
INNER JOIN HIST_SALARIO H
ON E.IDEMP = IDEMPREGADO
GO
...
/* CRIANDO PROCEDURE COM PARAMENTROS DE ENTRADA E PARAMETROS DE SAIDA  */
...
BEGIN 
	IF @NUMERO = 5 --EXPRESSAO BOLEANE - TRUE
...
/* PROCEDURE DINAMICA/ BLOCO NOMEADO */
CREATE PROC VERIFICACAO @NUMERO INT
AS
BEGIN
	IF @NUMERO = 5 --EXPRESSAO BOLEANE - TRUE
		PRINT 'O VALOR É VERDADEIRO'
